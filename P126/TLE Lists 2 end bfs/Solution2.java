...
class Solution {
    public List<List<String>> findLadders(String beginWord, String endWord, List<String> wordList) {
      ...
      helpConstruct(map, map.get(beginWord), thisAns, ans, endWord, mappedSet);
      return ans;

    }

    private boolean helpFind(Set<String> set1, Set<String> set2, Map<String, List<String>> map, Set<String> wordList, boolean direction){
        ...
        for(int i = 0 ; i < thisWord.length(); i++){
          ...
          for(char c = 'a';  c < ('a' + 26); c++){
            ...
            if(!set1.contains(newWord) && wordList.contains(newWord)){
              change = true;
              Set<String> thisKeySet = map.containsKey(key)? new HashSet<String>(map.get(key)):new HashSet<String>();
              ...
              map.put(key, new ArrayList<String>(thisKeySet));
            }
          }
          charArr[i] = thisChar;
        }
    ...
    private void helpConstruct(Map<String, List<String>> map, List<String> valList, List<String> thisAns ,List<List<String>> ans,  String endWord, Set<String> mappedSet ){
      ...
      for(String s: valList){
        ...
        if(!mappedSet.contains(s)) {
          ...
          newSet.add(s);
          helpConstruct(map, map.get(s), thisList, ans, endWord, newSet);
        }
      }
