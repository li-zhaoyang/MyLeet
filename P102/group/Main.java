...
class Main {
    public static void main(String argvs[]){
      ...
      t.left.left.left = new TreeNode(123);
      ...
      // System.out.println(slt.isSymmetric(t));
      // for( int i = 0 ; i < tL.size(); i++){
      //   Mid mid = new Mid();
      //   List<Integer> ans = mid.inorderTraversal(tL.get(i));
      //   for(int j = 0 ; j < ans.size(); j++){
      //     System.out.print(ans.get(j) + " ");
      //   }
      //   System.out.println("");
      // }
      List<List<Integer>> ans = slt.levelOrder(t);
